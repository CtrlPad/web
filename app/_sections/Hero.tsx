      ...
      <div className="z-2">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-5 p-5">
          <Link href="/docs" className="w-full md:w-auto">
            <Button size="lg" className="w-full md:w-48 h-12 text-xl bg-[#10B981] hover:bg-[#10B981]/80 rounded-md">
              Get started <ArrowRight size={16} strokeWidth={3} />
            </Button>
          </Link>
          <Link href="https://github.com/ctrlpad" className="w-full md:w-auto">
            <Button size="lg" variant="outline" className="w-full md:w-48 h-12 text-xl rounded-md">
